...
alter table stock_day_info add column market_type varchar(2);

insert into stock_day_info (stock_code,day_num,dt,volume,trading_value,close_price,open_price,high_price_low_price) values ()
